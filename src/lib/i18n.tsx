...
const dictionaries: Record<"en" | "sw", Record<string, string>> = {
  en: {
    ...
    "action.saved": "Action draft saved.",
    "action.saveError": "Could not save this action draft.",
  ...
  sw: {
    ...
    "action.saved": "Rasimu ya hatua imehifadhiwa.",
    "action.saveError": "Haikuwezekana kuhifadhi rasimu hii ya hatua.",
...
const extendedDictionaries: Record<Locale, Record<string, string>> = {
  ...
  ar: {
    ...
    "action.saved": "تم حفظ مسودة الإجراء.",
    "action.saveError": "تعذر حفظ مسودة الإجراء هذه.",
  ...
  fr: {
    ...
    "action.saved": "Brouillon d’action enregistré.",
    "action.saveError": "Impossible d’enregistrer ce brouillon d’action.",
  ...
  pt: {
    ...
    "action.saved": "Rascunho de ação salvo.",
    "action.saveError": "Não foi possível salvar este rascunho de ação.",
